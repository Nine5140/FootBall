		...
		<div id="content">
			...
			<div id="main_right">
				<s:form action="insertPlayer" method="post" id="insertPlayer">
					<table>
						<tr>
							<td><span>所属队伍:</span></td>
							<td><s:select name="team.id" list="list" listKey="id"
									listValue="teamname" headerKey="" headerValue="---请选择---"></s:select></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input type="text" name="player_num" class="input"
								required="required" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><s:select id="state" name="state"
									list="{'首发','替补'}" headerKey="" headerValue="---请选择---"/>
